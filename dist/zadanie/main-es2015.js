...
let ProductComponent = ProductComponent_1 = class ProductComponent {
    constructor(rest, route, router, http) {
        this.rest = rest;
        this.route = route;
        this.router = router;
        this.http = http;
        this.dataSource = [];
        this.headElements = ['picture', 'name', 'followers', 'repositories'];
        this.getProducts();
    ...
    getProducts() {
        const dataSources = new Array(30);
        const f = [];
        /*
    ...
    sortData(sort) {
        ...
        this.sortedData = data.sort((a, b) => {
            ...
            switch (sort.active) {
                case 'followers': return ProductComponent_1.compare(a.followers, b.followers, isAsc);
                case 'repositories': return ProductComponent_1.compare(a.repositories, b.repositories, isAsc);
                default: return 0;
            }
        });
    }
...
module.exports = __webpack_require__(/*! /Users/Martin/WebstormProjects/zadanie/src/main.ts */"./src/main.ts");
