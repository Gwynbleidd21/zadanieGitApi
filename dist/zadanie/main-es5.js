...
var ProductComponent = /** @class */ (function () {
    function ProductComponent(rest, route, router, http) {
        this.rest = rest;
        this.route = route;
        this.router = router;
        this.http = http;
    ...
    ProductComponent.compare = function (a, b, isAsc) {
        return (a < b ? -1 : 1) * (isAsc ? 1 : -1);
    };
    ProductComponent.prototype.ngOnInit = function () {
    };
    ProductComponent.prototype.getProducts = function () {
        var dataSources = new Array(30);
        var f = [];
        /*
    ...
    ProductComponent.prototype.btnClick = function (data) {
...
var configUrl = 'https://api.github.com/users';
var httpOptions = {
...
var RestService = /** @class */ (function () {
    ...
    RestService.prototype.getFollowers = function (followersUrl) {
